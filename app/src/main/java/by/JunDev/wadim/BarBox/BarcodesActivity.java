...
public class BarcodesActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(by.JunDev.wadim.BarBox.R.menu.action_bar_menu, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case by.JunDev.wadim.BarBox.R.id.share:
                workWithShare();
                break;
        }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(by.JunDev.wadim.BarBox.R.layout.barcodes_lat);
        ...
        readList();
        packArrays();
        charSequenceArrayAdapter = new ArrayAdapter<CharSequence>(getApplicationContext(), by.JunDev.wadim.BarBox.R.layout.test, createGlobalArray());
        listView = (ListView) findViewById(by.JunDev.wadim.BarBox.R.id.listOfCodes);
    ...
    public void editItem(final int position) {
        ...
        title.setTextColor(getResources().getColor(by.JunDev.wadim.BarBox.R.color.titleColor));
