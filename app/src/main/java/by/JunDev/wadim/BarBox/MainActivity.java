...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(by.JunDev.wadim.BarBox.R.layout.activity_main_lat);
        listView = (ListView) findViewById(by.JunDev.wadim.BarBox.R.id.listOfGroup);
        ...
        ArrayAdapter<CharSequence> adapter = new ArrayAdapter<CharSequence>(getApplicationContext(), by.JunDev.wadim.BarBox.R.layout.iteam_of_list_of_group, by.JunDev.wadim.BarBox.R.id.tvFromGroup, arr);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        menuInflater.inflate(by.JunDev.wadim.BarBox.R.menu.context_menu_group_barcodes, menu);
    }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case by.JunDev.wadim.BarBox.R.id.delete:
                deleteGroup(arr[contextMenuInfo.position]);
                break;
            case by.JunDev.wadim.BarBox.R.id.rename:
